...
> createRegistry(registry, xRequestId)
...
import com.ryan.openapi.harbor.client.api.RegistryApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        Registry registry = new Registry(); // Registry | The registry
        String xRequestId = "xRequestId_example"; // String | An unique ID for the request
        try {
            apiInstance.createRegistry(registry, xRequestId);
        } catch (ApiException e) {
            System.err.println("Exception when calling RegistryApi#createRegistry");
...
public class Example {
    public static void main(String[] args) {
        ...
        RegistryApi apiInstance = new RegistryApi(defaultClient);
        Long id = 56L; // Long | Registry ID
        String xRequestId = "xRequestId_example"; // String | An unique ID for the request
        try {
            apiInstance.deleteRegistry(id, xRequestId);
        } catch (ApiException e) {
            System.err.println("Exception when calling RegistryApi#deleteRegistry");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> Registry getRegistry(id, xRequestId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String xRequestId = "xRequestId_example"; // String | An unique ID for the request
        try {
            Registry result = apiInstance.getRegistry(id, xRequestId);
...
> RegistryInfo getRegistryInfo(id, xRequestId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String xRequestId = "xRequestId_example"; // String | An unique ID for the request
        try {
            RegistryInfo result = apiInstance.getRegistryInfo(id, xRequestId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RegistryApi#getRegistryInfo");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> List&lt;Registry&gt; listRegistries(xRequestId, q, sort, page, pageSize, name)
...
public class Example {
    public static void main(String[] args) {
        ...
        String name = "name_example"; // String | Deprecated, use `q` instead.
        try {
            List<Registry> result = apiInstance.listRegistries(xRequestId, q, sort, page, pageSize, name);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RegistryApi#listRegistries");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> Map&lt;String, RegistryProviderInfo&gt; listRegistryProviderInfos(xRequestId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String xRequestId = "xRequestId_example"; // String | An unique ID for the request
        try {
            Map<String, RegistryProviderInfo> result = apiInstance.listRegistryProviderInfos(xRequestId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RegistryApi#listRegistryProviderInfos");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> List&lt;String&gt; listRegistryProviderTypes(xRequestId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String xRequestId = "xRequestId_example"; // String | An unique ID for the request
        try {
            List<String> result = apiInstance.listRegistryProviderTypes(xRequestId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RegistryApi#listRegistryProviderTypes");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> pingRegistry(registry, xRequestId)
...
public class Example {
    public static void main(String[] args) {
        ...
        RegistryApi apiInstance = new RegistryApi(defaultClient);
        RegistryPing registry = new RegistryPing(); // RegistryPing | The registry
        String xRequestId = "xRequestId_example"; // String | An unique ID for the request
        try {
            apiInstance.pingRegistry(registry, xRequestId);
        } catch (ApiException e) {
            System.err.println("Exception when calling RegistryApi#pingRegistry");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> updateRegistry(id, registry, xRequestId)
...
public class Example {
    public static void main(String[] args) {
        ...
        RegistryApi apiInstance = new RegistryApi(defaultClient);
        Long id = 56L; // Long | The registry ID
        RegistryUpdate registry = new RegistryUpdate(); // RegistryUpdate | The registry
        String xRequestId = "xRequestId_example"; // String | An unique ID for the request
        try {
            apiInstance.updateRegistry(id, registry, xRequestId);
        } catch (ApiException e) {
            System.err.println("Exception when calling RegistryApi#updateRegistry");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
